...
/**
 * Servlet implementation class MissingOerderListServlet
 */
@WebServlet("/missingorder.bo")
public class MissingOrderListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MissingOrderListServlet() {
        super();
	...
	//전체 목록 갯수를 리턴받음
	int listCount = new MissingService().MissinggetListCount7(val);
	...
	//전체 목록 갯수를 리턴받음
	int listCount = new MissingService().MissinggetListCount8(val);
