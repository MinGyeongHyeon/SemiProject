...
/**
 * Servlet implementation class MissingReportServlet
 */
@WebServlet("/missingreport.bo")
public class MissingReportServlet extends HttpServlet {
	...
	//	System.out.println(reportin);
		...
		String msg = "";
		String page = "views/member/4_missing/1_fine/6_report.jsp";
		if(result > 0) {
			msg = "신고 가 완료 되었습니다";
