...
/**
 * Servlet implementation class MissingDeleteServlet
 */
@WebServlet("/missingDelete.bo")
public class MissingDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MissingDeleteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result > 0) {
			response.sendRedirect("/sixDestiny/missingListo.bo");
		}
