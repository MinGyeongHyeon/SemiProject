...
/**
 * Servlet implementation class MissingSearchServlet
 */
@WebServlet("/missingsearch.bo")
public class MissingSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MissingSearchServlet() {
        super();
...
if(val.equals("전체")) {
		...
		//전체 목록 갯수를 리턴받음
		int listCount = new MissingService().MissinggetListCount2(cont);
		...
		ArrayList<HashMap<String, Object>> list= new MissingService().MissngselectList2(currentPage,limit,cont);
...
if(val.equals("작성자")) {
	...
	//전체 목록 갯수를 리턴받음
	int listCount = new MissingService().MissinggetListCount4(cont);
	...
	ArrayList<HashMap<String, Object>> list= new MissingService().MissngselectList3(currentPage,limit,cont);
...
if(val.equals("제목")) {
	...
	//전체 목록 갯수를 리턴받음
	int listCount = new MissingService().MissinggetListCount5(cont);
	...
	ArrayList<HashMap<String, Object>> list= new MissingService().MissngselectList4(currentPage,limit,cont);
