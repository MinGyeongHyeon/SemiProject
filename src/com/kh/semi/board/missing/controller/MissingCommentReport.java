...
/**
 * Servlet implementation class MissingCommentReport
 */
@WebServlet("/missingCommentReport")
public class MissingCommentReport extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String msg = "";
		String page = "views/member/4_missing/1_fine/7_report_comment.jsp";
		if(result > 0) {
			msg = "신고 가 완료 되었습니다";
