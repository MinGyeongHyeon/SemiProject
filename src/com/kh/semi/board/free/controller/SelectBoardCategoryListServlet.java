...
/**
 * Servlet implementation class SelectBoardCategoryListServlet
 */
@WebServlet("/selectListCa.bo")
public class SelectBoardCategoryListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectBoardCategoryListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
				...
				//전체 목록 갯수를 리턴받음
				int listCount = new UserBoardService().getListCount(category);
				...
				ArrayList<UserBoard> list = new UserBoardService().selectList(currentPage, limit, category);
				System.out.println("다왔다!!!!"+list);
