...
/**
 * Servlet implementation class OkMoneyConfirmServlet
 */
@WebServlet("/okMoney.mon")
public class OkMoneyConfirmServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new MoneySupService().okConfirmMoney(monSupNo);
