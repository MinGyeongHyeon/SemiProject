...
/**
 * Servlet implementation class CommentBoardServlet
 */
...
public class CommentBoardServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<AdminComment> list = new AdminBoardService().selectListed(currentPage, limit);
		...
		int listCount2 = new AdminBoardService().getListCounted2();
		...
		ArrayList<AdminComment> list2 = new AdminBoardService().selectListed2(currentPage2, limit2);
		ArrayList<Integer> report = new AdminBoardService().CoreportCount(list2);
System.out.println("댓글 리포트수"+report);
		...
		request.getRequestDispatcher("views/admin/1_admin/9_commentManager.jsp").forward(request, response);	}
