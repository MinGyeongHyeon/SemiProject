...
public class searchBoard extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ab.setAdBoardCon(keyword);
		ab.setTitle(boardsearch);
		...
		//전체 목록 갯수를 리턴받음
		int listCount = new AdminBoardService().getListsearchCountad(ab);
		...
		ArrayList<AdminUserBoard> list = new AdminBoardService().searchBoard(currentPage, limit ,ab);
		ArrayList<Integer> recCount = new AdminBoardService().recsearchCount(list);
