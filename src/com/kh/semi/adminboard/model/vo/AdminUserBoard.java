...
public class AdminUserBoard implements java.io.Serializable{
	...
	public AdminUserBoard() {}




	public AdminUserBoard(int bNo, String bKind, String bNm, Date bDate, String bCon, int inqCon, int recCon, int sGrade,
			int uNo, String status, int boardNo, String missPlace, Date missDt, String missGender, String missPhone,
			String boardDiv, int rewardPc, String bUserNick) {
		super();
		this.bNo = bNo;
		this.bKind = bKind;
		this.bNm = bNm;
