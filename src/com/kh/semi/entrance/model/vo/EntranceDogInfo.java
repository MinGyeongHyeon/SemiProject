...
public class EntranceDogInfo {
	...
	public EntranceDogInfo() {}

	public EntranceDogInfo(int entNo, String dogNm, String dogAge, String dogGender, String dogKind, int dogWeight,
			int dogHeight, String inoYn, String disYn, String operYn, String allegy, String dogHobby, String dogBark,
			String dogBowel, String dogAct, String seperate, String furColor, String obYn, String regYn, String dogChar,
			int entAppNo, String dogSit, String[] t1, String[] tt1, String[] ttt1) {
		super();
		this.entNo = entNo;
		this.dogNm = dogNm;
		this.dogAge = dogAge;
	...
	public void setTtt1(String[] ttt1) {
		this.ttt1 = ttt1;
	}
	...
	public String toString() {
		return "EntranceDogInfo [entNo=" + entNo + ", dogNm=" + dogNm + ", dogAge=" + dogAge + ", dogGender="
				+ dogGender + ", dogKind=" + dogKind + ", dogWeight=" + dogWeight + ", dogHeight=" + dogHeight
				+ ", inoYn=" + inoYn + ", disYn=" + disYn + ", operYn=" + operYn + ", allegy=" + allegy + ", dogHobby="
				+ dogHobby + ", dogBark=" + dogBark + ", dogBowel=" + dogBowel + ", dogAct=" + dogAct + ", seperate="
				+ seperate + ", furColor=" + furColor + ", obYn=" + obYn + ", regYn=" + regYn + ", dogChar=" + dogChar
				+ ", entAppNo=" + entAppNo + ", dogSit=" + dogSit + ", t1=" + Arrays.toString(t1) + ", tt1="
				+ Arrays.toString(tt1) + ", ttt1=" + Arrays.toString(ttt1) + "]";
	}
