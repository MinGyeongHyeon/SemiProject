...
@WebServlet("/selectSelData.ent")
public class SelectEntranceSelDataServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		int entAppNo = Integer.parseInt(request.getParameter("entAppNo"));

		String result = new EntranceService().selectEntranceSElDate(entAppNo);
