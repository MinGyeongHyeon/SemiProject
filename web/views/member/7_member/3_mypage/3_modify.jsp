...
<% }%> --%>
	...
	<tr>
		...
		<td><input type="button" value="중복확인"> <input type="hidden" name="userNo" value="<%=loginUser.getUserNo()%>"></td>
...
<%} %>
	...
	<tr>
		<td><div style="color:black; padding:5px; width:100px">반려견 유무</div></td>
		<td>
	<% if(loginUser.getDogYn().equals("Y")) {%>
		<input type="radio" value="Y" name="dogYn" checked>있다
		<input type="radio" value="N" name="dogYn">없다
	<% } else{ %>
		<input type="radio" value="Y" name="dogYn" >있다
		<input type="radio" value="N" name="dogYn" checked>없다
	<%} %>
		</td>
	</tr>
