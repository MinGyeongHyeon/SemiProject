...
<table width="100%" height="300" border="0" cellspacing="0" cellpadding="0">
  <form id="report" name="report" method="post" action="<%= request.getContextPath() %>/missingCommentReport" onsubmit="return check();">
  <tbody><tr>
		...
		<table border="0" cellspacing="0" cellpadding="0" class="choice">
			...
			<tr>
				...
				<td><input id="reason10" name="reason" type="radio" value="R4">기타</td>
						...
						<tr>
				<td><input type="hidden" value="<%= request.getParameter("uNo")%>" name="uNo"></td>
				<td><input type="hidden" value="<%= request.getParameter("cNo")%>" name="cNo"></td>
				<td><input type="hidden" value="<%= request.getParameter("u2No")%>" name="u2No"></td>
			</tr>
		</tbody></table>
