...
<body>
		...
		<div class="container" style="margin-top:50px;">
		 ...
		 <form  action="<%=request.getContextPath() %>/missingfile.bo" method="post"  encType="multipart/form-data" >
...
<table class="table table-bordered" align="center">
            ...
            <tr>
                ...
                <td class="find" style="padding: 0;"><input type="text" placeholder="제목을 입력하세요. " name="title" class="form-control" style="width:486px;"></td>
            </tr>
            ...
            <tr>
                ...
                <td class="find" style="text-align: left; padding:0;" >
					...
					<input style="padding:0"; type="text" placeholder="장소를 입력하세요. " name="placedetail" class="form-control"  >
				</td>
			</tr>
				<tr>
                ...
                <td class="find" style="text-align: left; padding:0;">
                <input  type="date"  style=" height:20px; padding:8px; width:200px;"name="missdate" class="form-control"  >
 ...
 <input style="padding:0; width:50px; height: 25px;"  type="text"  name="reward"  class="form-control"  disabled="false">만원
  <input type="radio" name="radio" id="r2" value="0" checked><label for="r2">없음</label>
             ...
             <tr>
                ...
                <td class="find" style="padding: 0;"><input type="text" placeholder="전화번호를 입력하세요. " name="phone" class="form-control" style="width:486px;"></td>
            </tr>

              <tr>
                <td class="find" style="background:rgb(230, 230, 230); border-radius:10px;"><span>특징</span></td>
                <td class="find" style="padding: 0;"><textarea  rows="5" cols="30" name="content" class="form-control" style="width:486px; height:200px;"></textarea></td>
            </tr>
