...
<%
	ArrayList<AdminComment> list = (ArrayList<AdminComment>) request.getAttribute("list");
	ArrayList<AdminComment> list2 = (ArrayList<AdminComment>) request.getAttribute("list2");
...
<body>
   ...
   <table class="table" id="listArea" style=" border-spacing: 0px; width:80%;" align="center">
      ...
      <tr class="adtr" style="background:rgb(220,220,220);">
         ...
         <th class="adtd" style="width:300px;">댓글내용</th>
      ...
      <tbody id="remonebody">
     <%
							for (AdminComment ub : list) {
						%>
						 <tr class="adtr">
							<td class="adtd"><%=ub.getBoardNo()%></td>
							<td class="adtd"><%=ub.getbKind()%></td>
							<td class="adtd"><%=ub.getcCon()%></td>
							<td class="adtd"><%=ub.getcNo()%></td>
...
$("#listArea td").mouseenter(function(){
  ...
  <div class="pagingArea" align="center">
		<ul class="pagination">
			...
			<% if(currentPage != 1){ %>
			<li><a href="<%=request.getContextPath()%>/comment.bo?currentPage=1">◀◀</a></li>
			...
			<li><a href="<%=request.getContextPath()%>/comment.bo?currentPage=<%=(int)(Math.floor(currentPage/10))*10%>">◀</a></li>
			<%}else{ %>
			<li><a href="<%=request.getContextPath()%>/comment.bo?currentPage=<%=(int)(Math.floor((currentPage-1)/10))*10%>">◀</a></li>
			<%} %>
			...
			<% } else { %>
			<li><a href="<%=request.getContextPath()%>/comment.bo?currentPage=<%=p%>" disabled><%= p %></a></li>
			...
			<li><a href="<%=request.getContextPath()%>/comment.bo?currentPage=<%=(int)(Math.ceil(currentPage/10))*10+11%>">▶</a></li>

			<% }%>

			<% if(currentPage < maxPage){ %>
			<li><a href="<%=request.getContextPath()%>/comment.bo?currentPage=<%=maxPage%>">▶▶</a></li>
			<%} %>
		</ul>
		</div>
   ...
   <table class="adta" style=" border-spacing: 0px;" align="center">
      <tr class="adtr" style="background:rgb(220,220,220);">
         ...
         <td class="adtd" style="width:500px;">댓글내용</td>
         ...
         <%
						...
						%>
						 <tr class="adtr">
							...
							<td class="adtd"><%=list2.get(i).getcCon()%></td>
   ...
   $("#listArea2 td").mouseenter(function(){
    ...
    <ul class="pagination">
     <% if(currentPage2 != 1){ %>
			...
			<li><a href="<%=request.getContextPath()%>/comment.bo?currentPage1=<%=(int)(Math.floor(currentPage/10))*10%>">◀</a></li>
			<%}else{ %>
			<li><a href="<%=request.getContextPath()%>/comment.bo?currentPage1=<%=(int)(Math.floor((currentPage-1)/10))*10%>">◀</a></li>
			<%} %>
			...
			<% } else { %>
			<li><a href="<%=request.getContextPath()%>/comment.bo?currentPage1=<%=p%>" disabled><%= p %></a></li>
			...
			<li><a href="<%=request.getContextPath()%>/comment.bo?currentPage1=<%=(int)(Math.ceil(currentPage/10))*10+11%>">▶</a></li>
